...
import { approveReturnRequest } from "@/app/actions/ecommerce-return-actions"
...
export async function POST(
  ...
  try {
    ...
    const result = await approveReturnRequest(returnId, deviceId)
    ...
    console.error("API approve return error:", error)
    return NextResponse.json(
