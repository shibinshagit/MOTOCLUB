...
import { deleteReturnRequest } from "@/app/actions/ecommerce-return-actions"
...
export async function POST(
  ...
  try {
    ...
    const result = await deleteReturnRequest(returnId, deviceId)
    ...
    console.error("API delete return error:", error)
    return NextResponse.json(
