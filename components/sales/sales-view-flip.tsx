...
export type SalesViewMode = "info" | "entry"

interface SalesViewFlipProps {
  activeView: SalesViewMode
  listView: ReactNode
  entryView: ReactNode
}

export function SalesViewFlip({ activeView, listView, entryView }: SalesViewFlipProps) {
